...
export default function Projects() {
  ...
  const [projectsList, setProjectsList] = useState<ProjectItem[]>([
    { id: 1, name: 'Project name', title: '', content: '' },
  ]);
  ...
  const handleAddNewProject = () => {
    ...
    const newProj: ProjectItem = { id: newId, name: `Project ${projectsList.length + 1}`, title: '', content: '' };
        ...
        <div className="flex-1 flex overflow-hidden">
          <div className="flex-1 flex flex-col min-w-0 bg-[#f8fbfe] overflow-y-auto">
            <div className="p-4 sm:p-8 space-y-6 max-w-6xl mx-auto w-full">
              <div>
                <h1 className="text-2xl font-extrabold text-[#111827] tracking-tight">Projects</h1>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch min-h-[500px]">
                    ...
                    {projectsList.map((p) => {
                      ...
                      return (
                        <div
                          ...
                          className={`p-3.5 text-xs font-extrabold cursor-pointer transition-colors ${
                            isSelected
                ...
                <div className="lg:col-span-8 bg-white border border-[#e2ebf4] rounded-3xl p-6 shadow-xs flex flex-col justify-between space-y-4">
                  <div className="space-y-4">
                    <div className="flex items-center justify-between pb-3 border-b border-slate-100 text-slate-600 text-xs font-semibold">
